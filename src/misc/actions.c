...
} s_names2actions[] =
{
    ...
    { "vr-convergence-decrease", ACTIONID_VR_CONVERGENCE_DECREASE, },
    { "vr-convergence-increase", ACTIONID_VR_CONVERGENCE_INCREASE, },
    { "vr-convergence-reset", ACTIONID_VR_CONVERGENCE_RESET, },
